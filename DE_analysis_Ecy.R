...
###############################################################
# DE analysis of HS exp (Ecy) through counts (transcriptomics)
###############################################################
...
dir <- '~/labeglo2/Transcriptomics/quantification/HS_exp_labeglo1/Ecy/counts' # specify path to your samples
dir <- '~/labeglo2/Transcriptomics/quantification/HS_exp_labeglo1/3h/Ecy/count'
current_dir <- '~/labeglo2/Transcriptomics/quantification/HS_exp_labeglo1/Ecy'
current_dir <- '~/labeglo2/Transcriptomics/quantification/HS_exp_labeglo1/3h/Ecy'
...
sample_names <- c('24C_rep1', '24C_rep2', '24C_rep4',
                  '6C_rep1', '6C_rep2', '6C_rep3', '6C_rep4')
...
write.table(rownames_to_column(res, 'contig'),
            file = file.path(current_dir, 'Ecy_transcr_24vs6_all_3h.csv'),
