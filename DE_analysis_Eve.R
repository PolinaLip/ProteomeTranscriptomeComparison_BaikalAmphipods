...
dir <- '~/labeglo2/Transcriptomics/quantification/HS_exp_labeglo1/Eve/counts' # specify path to your samples
dir <- '~/labeglo2/Transcriptomics/quantification/HS_exp_labeglo1/3h/Eve/count'
...
files_names <- c('Eve_6C_rep1', 'Eve_6C_rep2', 'Eve_6C_rep3', 'Eve_6C_rep4', 
                 'Eve_24C_rep1', 'Eve_24C_rep2', 'Eve_24C_rep3', 'Eve_24C_rep4') # specify the names of folders with quant.sf data, Gla
files_names <- c('Eve_6C_rep1', 'Eve_6C_rep2', 'Eve_6C_rep3', 'Eve_6C_rep4', 
